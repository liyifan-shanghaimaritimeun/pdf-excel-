...
method = """    def _save_page_image(self, page_num: int) -> str:
...
content = content.replace('    def extract_tables(self, page_num: int = 0)', method + '    def extract_tables(self, page_num: int = 0)')
